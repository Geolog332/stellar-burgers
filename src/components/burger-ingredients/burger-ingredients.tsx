...
export const BurgerIngredients: FC = () => {
  const burgerIngredients = useSelector(selectIngredients); // Получение ингредиентов бургера из состояния Redux
  const burgerIngredientsError = useSelector(selectorIngredientsError); // Получение ошибки ингредиентов бургера из состояния Redux
